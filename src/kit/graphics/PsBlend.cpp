...
//  CinderTabletTest
//
//  Created by Eric Mika on 12/8/15.
//
//
#include "PsBlend.h"
#include "Resources.h"
...
void PsBlend::drawWithBlend(ci::gl::Texture2dRef texture, BlendMode blendMode) {
	// TODO
}

void PsBlend::drawWithBlend(ci::gl::Texture2dRef sourceTexture, ci::gl::Texture2dRef destinationTexture, BlendMode blendMode) {
	// TODO
}

ci::gl::GlslProgRef PsBlend::getBlendShaderRef() {
	if (mBlendShaderRef == nullptr) {
		// Initialize lazily
		try {
			// mBlendShaderRef = ci::gl::GlslProg::create(vertexShaderGL3, fragmentShaderGL3);

			mBlendShaderRef = ci::gl::GlslProg::create(ci::app::loadAsset("shaders/passthrough.vert"), ci::app::loadAsset("shaders/difference.frag"));
	...
	return mBlendShaderRef;
};

const std::string PsBlend::fragmentShaderGL2 = "#version 120\n \
    ...
    #define BlendLinearBurnBlendSubtract\n \
    ...
    #define LevelsControl(color, minInput, gamma, maxInput, minOutput, maxOutput) LevelsControlOutputRange(LevelsControlInput(color, minInput, gamma, maxInput), minOutput, maxOutput)\n" STRINGIFY(
		...
		uniform sampler2DRect blendTgt; uniform int mode;
		...
		void main() {
			...
			if (mode == 0) {
				...
				result = BlendSubtract(baseCol.rgb, blendCol.rgb);
			} else if (mode == 5) {
...
const std::string PsBlend::vertexShaderGL2 = "#version 150\n" STRINGIFY(

		uniform mat4 projectionMatrix; uniform mat4 modelViewMatrix; uniform mat4 textureMatrix; uniform mat4 modelViewProjectionMatrix;
...
const std::string PsBlend::fragmentShaderGL3 = "#version 150\n \
\
#define BlendLinearDodgef BlendAddf\n \
#define BlendLinearBurnf BlendSubtractf\n \
#define BlendAddf(base, blend) min(base + blend, 1.0)\n \
...
#define LevelsControl(color, minInput, gamma, maxInput, minOutput, maxOutput) LevelsControlOutputRange(LevelsControlInput(color, minInput, gamma, maxInput), minOutput, maxOutput)\n" STRINGIFY(
		...
		uniform sampler2DRect base; uniform sampler2DRect blendTgt; uniform int mode; out vec4 fragColor;
...
const std::string PsBlend::vertexShaderGL3 = "#version 150\n" STRINGIFY(
